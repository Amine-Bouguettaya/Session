...
-- Listage des données de la table session_amine.programme : ~18 rows (environ)
...
-- Listage des données de la table session_amine.session : ~12 rows (environ)
INSERT INTO `session` (`id`, `formation_id`, `name_session`, `date_debut`, `date_fin`, `nb_place`) VALUES
	...
	(12, 1, 'TESTTTT', '2025-02-01 00:00:00', '2025-02-24 00:00:00', 21);
...
-- Listage des données de la table session_amine.session_stagiaire : ~4 rows (environ)
...
-- Listage des données de la table session_amine.stagiaire : ~5 rows (environ)
